...
import {
  ...
  type SearchItemType,
  type SharedProps,
} from 'xyzdocs-radix-ui/components/dialog/search';
import { useDocsSearch } from 'xyzdocs-core/search/client';
import { fetchClient } from 'xyzdocs-core/search/client/fetch';
import { useMemo, useState } from 'react';
import { Popover, PopoverContent, PopoverTrigger } from 'xyzdocs-radix-ui/components/ui/popover';
import { ArrowRight, ChevronDown } from 'lucide-react';
import { buttonVariants } from 'xyzdocs-radix-ui/components/ui/button';
import { cn } from '@/lib/cn';
import { useTreeContext } from 'xyzdocs-radix-ui/contexts/tree';
import type { Item, Node } from 'xyzdocs-core/page-tree';
