export const semanticColors = [
  {
    ...
    tailwind: 'blue',
    name: '主要',
    meaning: '品牌、主题、可交互、正常',
  },
  {
    id: 'secondary',
    tailwind: 'sky',
    name: '次要',
    meaning: '品牌、主题、次级、常态的',
  },
...
export const oklchColors = {
  ...
  '--color-mist-400': 'oklch(72.3% 0.<PASSWORD> 214.4)',
  ...
  '--color-taupe-400': 'oklch(71.4% 0.<PASSWORD> 41.2)',
  '--color-taupe-500': 'oklch(54.7% 0.<PASSWORD> 43.1)',
