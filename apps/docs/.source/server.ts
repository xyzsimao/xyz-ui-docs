...
import { frontmatter as __fd_glob_12 } from "../content/docs/cli/preview.mdx?collection=docs&only=frontmatter"
import { frontmatter as __fd_glob_11 } from "../content/docs/cli/index.mdx?collection=docs&only=frontmatter"
import { frontmatter as __fd_glob_10 } from "../content/docs/cli/create-fumadocs-app.mdx?collection=docs&only=frontmatter"
import { frontmatter as __fd_glob_9 } from "../content/docs/mdx/collections.mdx?collection=docs&only=frontmatter"
...
export const docs = await create.docsLazy("docs", "content/docs", {"meta.json": __fd_glob_4, "cli/meta.json": __fd_glob_5, "mdx/meta.json": __fd_glob_6, "miscellaneous/meta.json": __fd_glob_7, }, {"tt.mdx": __fd_glob_8, "mdx/collections.mdx": __fd_glob_9, "cli/create-fumadocs-app.mdx": __fd_glob_10, "cli/index.mdx": __fd_glob_11, "cli/preview.mdx": __fd_glob_12, "miscellaneous/cva实现样式变体组件.mdx": __fd_glob_13, "miscellaneous/index.mdx": __fd_glob_14, "miscellaneous/markdown.mdx": __fd_glob_15, "miscellaneous/md_doc.mdx": __fd_glob_16, "miscellaneous/turborepo.mdx": __fd_glob_17, }, {"tt.mdx": () => import("../content/docs/tt.mdx?collection=docs"), "mdx/collections.mdx": () => import("../content/docs/mdx/collections.mdx?collection=docs"), "cli/create-fumadocs-app.mdx": () => import("../content/docs/cli/create-fumadocs-app.mdx?collection=docs"), "cli/index.mdx": () => import("../content/docs/cli/index.mdx?collection=docs"), "cli/preview.mdx": () => import("../content/docs/cli/preview.mdx?collection=docs"), "miscellaneous/cva实现样式变体组件.mdx": () => import("../content/docs/miscellaneous/cva实现样式变体组件.mdx?collection=docs"), "miscellaneous/index.mdx": () => import("../content/docs/miscellaneous/index.mdx?collection=docs"), "miscellaneous/markdown.mdx": () => import("../content/docs/miscellaneous/markdown.mdx?collection=docs"), "miscellaneous/md_doc.mdx": () => import("../content/docs/miscellaneous/md_doc.mdx?collection=docs"), "miscellaneous/turborepo.mdx": () => import("../content/docs/miscellaneous/turborepo.mdx?collection=docs"), });