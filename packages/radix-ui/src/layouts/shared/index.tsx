...
import * as PageTree from 'xyzdocs-core/page-tree'
import { type FC, useMemo, type ComponentProps, type ReactNode } from 'react'
import type { I18nConfig } from 'xyzdocs-core/i18n'
import {
  FullSearchTriggerProps,
  SearchTriggerProps,
} from './slots/search-trigger'
import { BaseSlots } from './client'
import { ThemeSwitchProps } from './slots/theme-switch'
