...
import type { HighlightedText, ReactSortedResult as BaseResultType } from 'xyzdocs-core/search';
import { cva } from 'class-variance-authority';
import { useRouter } from 'xyzdocs-core/framework';
import type { SharedProps } from '@/contexts/search';
import { useOnChange } from 'xyzdocs-core/utils/use-on-change';
import scrollIntoView from 'scroll-into-view-if-needed';
import { buttonVariants } from '@/components/ui/button';
import { createMarkdownRenderer } from 'xyzdocs-core/content/md';
