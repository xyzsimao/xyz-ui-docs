...
import { SearchClient, useDocsSearch } from 'xyzdocs-core/search/client';
import { fetchClient } from 'xyzdocs-core/search/client/fetch';
import { type ReactNode, use, useMemo, useState } from 'react';
import { useOnChange } from 'xyzdocs-core/utils/use-on-change';
...
import type { SortedResult } from 'xyzdocs-core/search';
...
let STATIC: Promise<typeof import('xyzdocs-core/search/client/orama-static')> | undefined;
...
export default function DefaultSearchDialog({
  ...
  if (type === 'static') {
    ...
    client = use((STATIC ??= import('xyzdocs-core/search/client/orama-static'))).staticClient({
      from: api,
      locale,
      tag,
    });
